...
class insertarProductoAreaCliente extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return insertarProductoAreaClienteState();
  }
}

class insertarProductoAreaClienteState extends State<insertarProductoAreaCliente>{
  final txtProducto = TextEditingController();
  final txtAreaCliente = TextEditingController();
  final txtConsumo = TextEditingController();

  List dataProducto, dataAreaCliente;
  var isLoading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Insertar producto área cliente'),
  ...
  Future<http.Response> guardarAreaCliente() async{
    final URL = Strings.direccion + 'productosareascliente';
